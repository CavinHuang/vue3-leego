...
function calculateLeftTop (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
...
function calculateRightTop (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
  const { symmetricPoint } = pointInfo
  let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateRightBottom (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
  const { symmetricPoint } = pointInfo
  let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateLeftBottom (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
  const { symmetricPoint } = pointInfo
  let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateTop (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
...
function calculateRight (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
  const { symmetricPoint, curPoint } = pointInfo
  const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
function calculateBottom (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
  const { symmetricPoint, curPoint } = pointInfo
  const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
function calculateLeft (style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
  const { symmetricPoint, curPoint } = pointInfo
  const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
export default function calculateComponentPositonAndSize (name: string, style: any, curPositon: any, proportion: any, needLockProportion: any, pointInfo: any) {
